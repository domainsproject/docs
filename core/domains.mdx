...
To register, follow the [Get Started](/getting-started) guide.
...
Sponsors will be recognized on the [Supporters](/supporters) page and on this list once their domain goes live.

To sponsor a domain, [open an issue](https://github.com/yourorg/register/issues) or [contact us directly](mailto:you@example.com).
