...
To sponsor a domain, [open an issue](https://github.com/domainsproject/register/issues) or join our [Discord community](https://discord.gg/jtVHRF9CdK).

---

If you're unsure whether your domain qualifies or need help setting it up, we're happy to assist. Join our [Discord community](https://discord.gg/jtVHRF9CdK) anytime.
