...
<AccordionGroup>
  ...
  <Accordion icon="code-fork" title="1. Fork the repository">
    Go to our [GitHub repository](https://github.com/yourorg/register) and fork it to your GitHub account. This will create your own editable copy.
  </Accordion>
...
<CardGroup>
  ...
  <Card title="Git-based and open" icon="code" href="https://github.com/yourorg/register">
...
Learn more on the [Domains](/domains) page or [Sponsor a domain](/supporters).
