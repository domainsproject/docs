...
If you need more (e.g., for an org or platform), [open an issue](https://github.com/domainsproject/register/issues) to discuss your use case.
...
Not sure if your use case is allowed? [Open an issue](https://github.com/domainsproject/register/issues) and we’ll be happy to help.
